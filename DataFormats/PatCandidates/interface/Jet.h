...
inline float pat::Jet::chargedHadronEnergy() const
{
  ...
  else if( isGenJet() ){ return genSpecific().mChargedHadronEnergy; }
...
inline float pat::Jet::neutralHadronEnergy() const
{
  ...
  else if( isGenJet() ){ return genSpecific().mNeutralHadronEnergy; }
...
inline float pat::Jet::chargedEmEnergy() const
{
  ...
  else if( isGenJet() ){ return genSpecific().mChargedEmEnergy;}
...
inline float pat::Jet::neutralEmEnergy() const
{
  ...
  else if( isGenJet() ){ return genSpecific().mNeutralEmEnergy;}
...
inline int pat::Jet::muonMultiplicity() const
{
  ...
  else if(isGenJet()){ return GenSpecific().mMuonMultiplicity; }
...
inline int pat::Jet::chargedMultiplicity() const
{
  ...
  else if(isGenJet()){ return genSpecific().mChargedHadronMultiplicity + genSpecific().mChargedEmMultiplicity; }
  else if( isJPTJet() ){ return jptSpecific().muonsInVertexInCalo.size()+jptSpecific().muonsInVertexOutCalo.size()+
